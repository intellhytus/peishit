...
<div>
    <form wire:submit.prevent="store">
        <div class="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
            <div class="px-4 py-2 bg-white rounded-t-lg dark:bg-gray-800">
                ...
                <textarea wire:model="message" id="comment" rows="4" class="w-full px-0 text-sm text-gray-900 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Diga aí, irmão" required ></textarea>
    ...
    <p class="ms-auto text-xs text-gray-500 dark:text-gray-400">Peixe com educação!</p>
